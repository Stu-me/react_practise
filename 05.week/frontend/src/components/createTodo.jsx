...
export default function CreateTodo() {
    return <>
        ...
        <input type="text" placeholder="Title" className="border-2 align-middle p-1 m-1 bg-white" /><br />
        <input type="text" placeholder="Description" className="border-2 align-middle p-1 m-1 bg-white" /><br />
